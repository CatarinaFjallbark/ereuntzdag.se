...
//		LABEL_LAST = ' and ';
		LABELS_SINGLUAR = ' millisekund| sekund| minut| timme| dag| vecka| månad| år| decade| century| millennium'.split('|');
		LABELS_PLURAL = ' millisekunder| sekunder| minuter| timmar| dagar| veckor| månader| år| decades| centuries| millennia'.split('|');
		LABEL_LAST = ' och ';
		LABEL_DELIM = ', ';
		LABEL_NOW = '';
